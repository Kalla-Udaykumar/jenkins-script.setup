            ...
            steps {
                script {
                    ...
                    dir("${WORKING_DIR}\\IFWI_Automation\\Builder"){
                        ...
                        copy \\\\amr.corp.intel.com\\ec\\proj\\IOTG\\Releases\\BIOS\\MeteorLake\\ARL-H\\%BIOS_VERSION%\\ROM\\pre_prod\\*.rom ${WORKING_DIR}\\IFWI_Automation\\ARL\\ARL_H\\INPUT\\IOTG_BIOS\\
